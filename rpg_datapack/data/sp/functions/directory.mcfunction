...
execute if entity @s[type=arrow] store result score %level arrow run data get entity @s CustomPotionEffects[1].Amplifier

execute if score %level arrow matches 27 at @s run function sp:arrows/tnt

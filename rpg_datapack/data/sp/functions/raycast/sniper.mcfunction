...
execute as @e[type=!#sp:protect,dx=0,limit=1,sort=nearest] positioned ~-0.9 ~-0.9 ~-0.9 if entity @s[dx=0] run execute store result score output.damage calc if entity @p[tag=user] run data get entity @e[type=item,tag=user,limit=1] Item.tag.DamageRPG 10
...
execute as @e[type=!#sp:protect,dx=0,limit=1,sort=nearest] positioned ~-0.9 ~-0.9 ~-0.9 if entity @s[dx=0] if score @s dynamic_health matches ..0 run kill @s[type=!ender_dragon]
execute as @e[type=!#sp:protect,dx=0,limit=1,sort=nearest] positioned ~-0.9 ~-0.9 ~-0.9 if entity @s[dx=0] if score @s dynamic_health matches ..0 run data merge entity @s[type=ender_dragon] {DragonPhase:9}
...
execute as @a[dx=0,limit=1,sort=nearest,tag=!user,nbt={DeathTime:0s},gamemode=!spectator,gamemode=!creative] positioned ~-0.9 ~-0.9 ~-0.9 if entity @s[dx=0] run execute store result score output.damage calc if entity @p[tag=user] run data get entity @e[type=item,tag=user,limit=1] Item.tag.DamageRPG 10
execute as @a[dx=0,limit=1,sort=nearest,tag=!user,nbt={DeathTime:0s},gamemode=!spectator,gamemode=!creative] positioned ~-0.9 ~-0.9 ~-0.9 if entity @s[dx=0] run scoreboard players operation output.damage calc /= integers.10 calc
...
execute as @e[type=armor_stand,dx=0,limit=1,sort=nearest,tag=dummy] positioned ~-0.9 ~-0.9 ~-0.9 if entity @s[dx=0] run execute store result score output.damage calc if entity @p[tag=user] run data get entity @e[type=item,tag=user,limit=1] Item.tag.DamageRPG 10
